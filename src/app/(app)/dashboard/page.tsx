            ...
            {hasMonthlyLimit ? (
              <div className="flex items-center gap-6 flex-wrap sm:flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-mono uppercase tracking-widest text-black/40 mb-1.5" style={{ fontFamily: 'var(--font-ibm-plex-mono), monospace' }}>Monthly usage quota</p>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-black/60">analysed · up to {plan.bugs_per_run_limit} per run · unlimited</span>
                  </div>
                </div>
              </div>
            )}
