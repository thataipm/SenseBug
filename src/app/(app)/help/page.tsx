...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Is there a bug limit per run?', a: 'There\'s a fair-use cap on monthly analysis volume, set high enough that you\'ll rarely hit it. If a single CSV exceeds the per-batch cap, SenseBug sorts by original priority first so your most critical bugs are always included.' },
    ],
  },
  {
  ...
  },
  {
    section: 'Billing',
    items: [
      { q: 'Is there a free trial?', a: 'Yes. Every signup gets a 14-day free trial with the full product, no credit card required. There\'s one plan at $29/mo. After 14 days, subscribe to continue. Your backlog, runs, and verdicts stay intact regardless.' },
